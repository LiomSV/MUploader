	        ...
	        <div class="pagination">
	            <ul>
	                <c:choose>
	                    ...
	                    <c:otherwise>
	                        <li><a href="artist/${artist.getIdArtist() }/${page-1 }">&laquo;</a></li>
	                    </c:otherwise>
	                </c:choose>
	                ...
	                <c:forEach var="i" begin="1" end="${pages }">
	                    <c:choose>
	                        ...
	                        <c:otherwise>
	                            <li><a href="artist/${artist.getIdArtist() }/${i }">${i }</a></li>
	                        </c:otherwise>
	                    </c:choose>                        
	                </c:forEach>                    
	                ...
	                <c:choose>
	                    ...
	                    <c:otherwise>
	                        <li><a href="artist/${artist.getIdArtist() }/${page+1 }">&raquo;</a></li>
	                    </c:otherwise>
	                </c:choose>
	            </ul>
	        </div>
